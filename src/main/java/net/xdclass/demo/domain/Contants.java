...
public class Contants {
    ...
    public static final String ffmpegpath = "E:/ffmpeg/windows/ffmpeg-20181111-e24a754-win64-static/ffmpeg-20181111-e24a754-win64-static/bin/ffmpeg.exe";     // ffmpeg工具安装位置
//    public static final String mencoderpath = "D:/ffmpeg/bin/mencoder";     // mencoder工具安装的位置
    ...
    public static final String videoRealPath = "G:/video/";    // 需要被截图的视频目录

    //    public static final String targetfolder = "E://Projectpicture/websiteimages/finshvideo/"; // 转码后视频保存的目录
    public static final String imageRealPath = "G:/image/"; // 截图的存放目录
}
